...
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/js/nbw-parallax-2013.js"></script>
...
$(function(){
	...
	if ($(window).width() <= 568) {
		...
		$('img.wp-image-223').attr('src','http://sprout-works.com/wp-content/uploads/2013/07/ipad-portrait-Creative_Thumbnails.png');
		$('img.wp-image-223').attr('width','511');
		$('img.wp-image-223').attr('height','149');			
	}
