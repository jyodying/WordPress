	...
	*/
	...
	function Move(){ 
		...
		if($thirdBG.hasClass("inview")){
			...
			lightbulb.css({'backgroundPosition': newPos(50, windowHeight, pos, initadjuster+windowHeight*2.855, 0.6),'width': windowWidth+ "px",'height': windowHeight+ "px"});	
			} else if (($window.width() > 768) && ($window.width() <= 1024)) {
			lightbulb.css({'backgroundPosition': newPos(50, windowHeight, pos, initadjuster+windowHeight*2.625, 0.6),'width': windowWidth+ "px",'height': windowHeight+ "px"});	
			} else {
